"use strict";(self.webpackChunkyozm_cafe=self.webpackChunkyozm_cafe||[]).push([[694],{"./src/components/LikeButton.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>LikeButton_stories});var react=__webpack_require__("./node_modules/react/index.js"),index_esm=__webpack_require__("./node_modules/react-icons/pi/index.esm.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const LikeButton=({likeCount,active,onChange})=>{const[isLiked,setIsLiked]=(0,react.useState)(active),[announce,setAnnounce]=(0,react.useState)("");return(0,jsx_runtime.jsxs)(Container,{"aria-label":"좋아요 버튼",tabIndex:0,role:"button",children:[(0,jsx_runtime.jsx)(HeartIcon,{$active:isLiked,onClick:()=>{setIsLiked((prevIsLiked=>!prevIsLiked)),setAnnounce(isLiked?"좋아요 취소되었습니다.":"좋아요가 추가되었습니다."),setTimeout((()=>setAnnounce("")),1e3),onChange?.()}}),(0,jsx_runtime.jsx)(LikeCount,{children:likeCount}),(0,jsx_runtime.jsx)(Announcement,{"aria-live":"assertive","aria-atomic":"true","aria-relevant":"text",children:`${likeCount} ${announce}`})]})};LikeButton.displayName="LikeButton";const components_LikeButton=LikeButton,HeartIcon=(0,styled_components_browser_esm.zo)(index_esm.r6X)`
  cursor: pointer;
...
//# sourceMappingURL=components-LikeButton-stories.fada6134.iframe.bundle.js.map