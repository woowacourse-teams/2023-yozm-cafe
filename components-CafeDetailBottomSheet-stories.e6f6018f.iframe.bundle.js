...
`;try{OpeningHoursDetail.displayName="OpeningHoursDetail",OpeningHoursDetail.__docgenInfo={description:"",displayName:"OpeningHoursDetail",props:{openingHours:{defaultValue:null,description:"",name:"openingHours",required:!0,type:{name:"OpeningHour[]"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/OpeningHoursDetail.tsx#OpeningHoursDetail"]={docgenInfo:OpeningHoursDetail.__docgenInfo,name:"OpeningHoursDetail",path:"src/components/OpeningHoursDetail.tsx#OpeningHoursDetail"})}catch(__react_docgen_typescript_loader_error){}const CafeDetailBottomSheet=props=>{const{show,cafe,onClose}=props;(0,react.useEffect)((()=>(document.addEventListener("click",onClose),()=>document.removeEventListener("click",onClose))),[onClose]);return(0,jsx_runtime.jsxs)(CafeDetailBottomSheet_Container,{$show:show??!1,onClick:event=>{event.stopPropagation()},role:"dialog","aria-modal":"true",children:[(0,jsx_runtime.jsx)(CloseButton,{children:(0,jsx_runtime.jsx)(CloseIcon,{onClick:onClose})}),(0,jsx_runtime.jsx)(Title,{children:cafe.name}),(0,jsx_runtime.jsxs)(InfoContainer,{children:[(0,jsx_runtime.jsxs)(LocationDetail,{children:[(0,jsx_runtime.jsx)(index_esm.Pat,{}),(0,jsx_runtime.jsx)("a",{href:cafe.detail.mapUrl,target:"_blank",rel:"noopener noreferrer",children:(0,jsx_runtime.jsxs)(LocationName,{children:[cafe.address," ",(0,jsx_runtime.jsx)(index_esm.y_S,{})]})})]}),(0,jsx_runtime.jsx)(OpeningHoursDetails,{children:(0,jsx_runtime.jsx)(components_OpeningHoursDetail,{openingHours:cafe.detail.openingHours})})]}),(0,jsx_runtime.jsx)(Content,{children:cafe.detail.description.split("\n").map(((paragraph,index)=>(0,jsx_runtime.jsx)("p",{children:paragraph},index)))}),(0,jsx_runtime.jsx)(MoreContentHintGradient,{})]})};CafeDetailBottomSheet.displayName="CafeDetailBottomSheet";const components_CafeDetailBottomSheet=CafeDetailBottomSheet,CafeDetailBottomSheet_Container=styled_components_browser_esm.zo.div`
  position: absolute;
  bottom: 0;
...
//# sourceMappingURL=components-CafeDetailBottomSheet-stories.e6f6018f.iframe.bundle.js.map